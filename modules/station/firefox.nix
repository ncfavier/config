    ...
    programs.firefox = {
      ...
      profiles.default = with config.theme; {
        ...
        settings = {
          ...
          "browser.uiCustomization.state" = ''{"placements":{"widget-overflow-fixed-list":[],"unified-extensions-area":["dearrow_ajay_app-browser-action","ublock0_raymondhill_net-browser-action","_a4c4eda4-fb84-4a84-b4a1-f7c1cbf2a1ad_-browser-action","redirector_einaregilsson_com-browser-action","jid1-kkzogwgsw3ao4q_jetpack-browser-action","treestyletab_piro_sakura_ne_jp-browser-action","_34daeb50-c2d2-4f14-886a-7160b24d66a4_-browser-action","addon_darkreader_org-browser-action","_12cf650b-1822-40aa-bff0-996df6948878_-browser-action","_16cbd87c-eb99-4f5c-9825-83cf13ab7ff8_-browser-action","zotero_chnm_gmu_edu-browser-action"],"nav-bar":["back-button","forward-button","vertical-spacer","stop-reload-button","urlbar-container","bookmarks-menu-button","downloads-button","unified-extensions-button","reset-pbm-toolbar-button"],"toolbar-menubar":["menubar-items"],"TabsToolbar":["tabbrowser-tabs","new-tab-button","alltabs-button"],"vertical-tabs":[],"PersonalToolbar":["personal-bookmarks"]},"seen":["_a4c4eda4-fb84-4a84-b4a1-f7c1cbf2a1ad_-browser-action","redirector_einaregilsson_com-browser-action","jid1-kkzogwgsw3ao4q_jetpack-browser-action","treestyletab_piro_sakura_ne_jp-browser-action","_34daeb50-c2d2-4f14-886a-7160b24d66a4_-browser-action","addon_darkreader_org-browser-action","ublock0_raymondhill_net-browser-action","developer-button","_12cf650b-1822-40aa-bff0-996df6948878_-browser-action","_16cbd87c-eb99-4f5c-9825-83cf13ab7ff8_-browser-action","zotero_chnm_gmu_edu-browser-action","dearrow_ajay_app-browser-action","screenshot-button"],"dirtyAreaCache":["nav-bar","widget-overflow-fixed-list","toolbar-menubar","TabsToolbar","PersonalToolbar","unified-extensions-area","vertical-tabs"],"currentVersion":23,"newElementCount":14}'';
